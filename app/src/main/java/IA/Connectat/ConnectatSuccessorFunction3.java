                ...
                if (graus[NCentrals + i] == 0) { // si el repetidor no est� usat
                    for (int u = 0; u < NCentrals + NRepetidors; u++) {
                        for (int v = u + 1; v < NCentrals + NRepetidors; v++) {
                            if (connexions[u][v] && connexions[v][u] && i != u && i != v) { // comprovem que els nodes
                                                                                            // estiguin connectats i que
                                                                                            // no sigui el propi node
                                                                                            // que volem afegir
                                ...
                                llistaSuccessors.add(new Successor("Afegit repetidor " + (NCentrals + i)
                    ...
                    for (int u = 0; u < NCentrals + NRepetidors; u++) {
                        for (int v = 0; v < NCentrals + NRepetidors; v++) {
                            for (int w = 0; w < NCentrals + NRepetidors; w++) {
                                if (connexions[u][v] && connexions[v][w] && i != u && i != v && u != w && i != w) { // comprovem
                                                                                                                    // que
                                                                                                                    // els
                                                                                                                    // nodes
                                                                                                                    // estiguin
                                    ...
                                    llistaSuccessors.add(new Successor("Afegit repetidor " + (NCentrals + i)
                                            + " entre els nodes " + u + " , " + v + " i " + w + ".", newCBoard));
                                }
                            }
                        }
                    }
                        ...
                        for (int v = 0; v < NCentrals + NRepetidors; v++) {
                            for (int w = 0; w < NCentrals + NRepetidors; w++) {
                                for (int s = 0; s < NCentrals + NRepetidors; s++) {
                                    if (connexions[u][v] && connexions[v][w] && connexions[w][s] && i != u && i != v
                                            && i != w && i != s && u != w && v != s) { // comprovem que els nodes
                                                                                       // estiguin connectats i que no
                                                                                       // sigui el propi node que volem
                                                                                       // afegir
                                        // afegir el repetidor i entre els nodes u i v
                                        ConnectatBoard newCBoard = new ConnectatBoard(CBoard);
                                        newCBoard.afegirRepetidor(i, u, v, w, s);
                                        llistaSuccessors.add(new Successor("Afegit repetidor " + (NCentrals + i)
                                                + " entre els nodes " + u + " , " + v + " , " + w + " i " + s + ".",
                                                newCBoard));
                                    }
                                }
                            }
                            ...
                            for (int w = 0; w < NCentrals + NRepetidors; w++) {
                                for (int s = 0; s < NCentrals + NRepetidors; s++) {
                                    for (int t = 0; t < NCentrals + NRepetidors; t++) {
                                        if (connexions[u][v] && connexions[v][w] && connexions[w][s] && connexions[s][t]
                                                && i != u && i != v && i != w && i != s && i != t && u != w && v != s
                                                && w != t) { // comprovem que els nodes estiguin connectats i que no
                                                             // sigui el propi node que volem afegir
                                            // afegir el repetidor i entre els nodes u i v
                                            ConnectatBoard newCBoard = new ConnectatBoard(CBoard);
                                            newCBoard.afegirRepetidor(i, u, v, w, s, t);
                                            llistaSuccessors.add(new Successor(
                                                    "Afegit repetidor " + (NCentrals + i) + " entre els nodes " + u
                                                            + " , " + v + " , " + w + " , " + s + " i " + t + ".",
                                                    newCBoard));
                                        }
                                    }
