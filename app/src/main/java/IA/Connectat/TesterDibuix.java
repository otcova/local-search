...
public class TesterDibuix {
    ...
    private static void crearGUI() throws Exception {
        ...
        panell.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Dibuix Graf"),
        ...
        if (width != 0 && height != 0) {
            dibu = new DibuixCiutat(width, height, ciutat.getM(), ciutat.getN(), ciutat.getCentrals(),
                    ciutat.getRepetidors(), ciutat.getConnexions());
        } else {
