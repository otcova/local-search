...
public class ConnectatJFrame extends javax.swing.JFrame {
    ...
    public ConnectatJFrame() {
        ...
        ciutat.generarCiutat(Integer.parseInt(nText.getText()), Integer.parseInt(mText.getText()),
                Integer.parseInt(nCentralsText.getText()), Integer.parseInt(nRepetidorsText.getText()));
         ...
         * dibuixCiutat1 = new
         * DibuixCiutat(width,height,ciutat.getM(),ciutat.getN(),ciutat.getCentrals(),
    ...
    private void initComponents() {
        ...
        int height = 200;
        ciutat = new ConnectatBoard();
        dibuixCiutat1 = new DibuixCiutat(width, height, ciutat.getM(), ciutat.getN(), ciutat.getCentrals(),
                ciutat.getRepetidors(), ciutat.getConnexions());
        ...
        estatInicialCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Aleatori (tal com s'han creat)",
                "Aleatori, centrals amb tres connexions", "Dist�ncia m�nima entre centrals",
                "Dist�ncia m�nima, centrals amb tres connexions", "Dist�ncia m�nima, amb repetidors" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        operadorsCombo
                .setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1: Afegir repetidor entre dos nodes",
                        "2: TreureRepetidor + AfegirRepetidor", "3: afegir repet. entre 2-5 nodes", "4: 3+treure rep.",
                        "5: 1+swap", "6: 1+moure aresta", "7: 1+moure aresta+swap" }));
        ...
        heuristicCombo.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] { "Error Total", "Error total + num. repetidors",
                        "Error total x num. repetidors", "(Error total * num. repetidors) / Sum. graus repet.",
                        "(Error total + num. repetidors)*dist. m�xima" }));
    ...
    private void simulatedAnButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_simulatedAnButtonActionPerformed
        ...
        try {
            ...
            infoSA.setText("Error Final: " + cerca.getEstatFinal().getErrorTotal() + "\nRepetidors Usats: "
                    + cerca.getEstatFinal().getNumRepetidors() + "\n" + cerca.getPropietats() + cerca.getAccions());
            cerca.fitxerResultats(ciutat, info_einicial, info_algoritme, info_operadors, info_heuristic, info_k,
        ...
        switch (op) {
            case 0:
                ...
                operadorsInfo.setText(
                        "Afegeix un repetidor no usat entre dos nodes directament connectats. Desconnecta els dos nodes i els connecta al repetidor.");
                break;
            case 1:
                operadors = new ConnectatSuccessorFunction2();
                operadorsInfo.setText(
                        "Treure repetidor desconnecta el repetidor de tots els seus ve�ns i els connecta entre ells formant un cam�.");
                break;
            case 2:
                operadors = new ConnectatSuccessorFunction3();
                operadorsInfo.setText(
                        "Afegeix repetidor no usat entre un conjunt de nodes, entre 2 i 5, que formin un cam� entre ells. Desconnecta tots els nodes i els connecta directament al repetidor afegit.");
                break;
            case 3:
            ...
            case 5:
                ...
                operadorsInfo.setText(
                        "Afegir repetidor entre dos nodes, i tamb� moure una aresta existent sense formar bucles.");
                break;
            case 6:
        ...
        switch (heu) {
            ...
            case 3:
                ...
                heuristicInfo.setText(
                        "Minimitza l'error total * els repetidors usats, i a m�s maximitza el sumatori de graus dels repetidors");
                break;
            case 4:
                heuristic = new ConnectatHeuristicFunction5();
                heuristicInfo.setText(
                        "Minimitza l'error total + els repetidors usats, i a m�s minimitza la dist�ncia m�xima entre les arestes del graf");
                break;
            default:
    ...
    private boolean comprovarParams() {
        ...
        try {
            ...
            if (m < 0 || n < 0 || nc < 0 || nr < 0 || alfa < 0 || beta < 0 || gamma < 0 || maxrep < 0)
                throw new Exception();
        } catch (Exception e) {
