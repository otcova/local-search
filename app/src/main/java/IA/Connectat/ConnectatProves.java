...
public class ConnectatProves {
    ...
    private static void provaSA() {
        ...
        try {
            cerca = new ConnectatCercador(ciutat, operadors, heuristic, info_iter, info_passos_iter, info_k,
                    info_lambda);
            cerca.executarCerca();
            cerca.fitxerResultats(ciutat, info_einicial + 1, "SA", info_operadors, info_heuristic, info_k, info_iter,
                    info_passos_iter, info_lambda);
        } catch (Exception e) {
