...
public class DistribucionGrafico extends javax.swing.JFrame {
    ...
    private void inicializarDatos() {
        ...
        for (int i = 0; i < maxC; i++) {
            if (((String) model2.getValueAt(i, 1)).length() == 0) {
                model2.setRowCount(i);
                break;
            }
            if (((Integer) model2.getValueAt(i, 2)) == null) {
                model2.setRowCount(i);
                break;
            }
            if (((Integer) model2.getValueAt(i, 3)) == null) {
                model2.setRowCount(i);
                break;
            }
            if (((Integer) model2.getValueAt(i, 4)) == null) {
                model2.setRowCount(i);
                break;
            }
            od.addConsumidor(i, (String) model2.getValueAt(i, 1), ((Integer) model2.getValueAt(i, 3)).intValue(),
                    ((Integer) model2.getValueAt(i, 2)).intValue(), ((Integer) model2.getValueAt(i, 4)).intValue());
        }
        for (int j = 0; j < maxP; j++) {
            if (((String) model1.getValueAt(j, 1)).length() == 0) {
                model1.setRowCount(j);
                break;
            }
            if (((Integer) model1.getValueAt(j, 2)) == null) {
                model1.setRowCount(j);
                break;
            }
            if (((Integer) model1.getValueAt(j, 3)) == null) {
                model1.setRowCount(j);
                break;
            }
            if (((Integer) model1.getValueAt(j, 4)) == null) {
                model1.setRowCount(j);
                break;
            }
            od.addPaquete(j, (String) model1.getValueAt(j, 1), ((Integer) model1.getValueAt(j, 3)).intValue(),
                    ((Integer) model1.getValueAt(j, 2)).intValue(), ((Integer) model1.getValueAt(j, 4)).intValue(),
                    ((Integer) model1.getValueAt(j, 5)).intValue());
        }
    }
    ...
    private void DistHillClimbingSearch(Distribucion dist) {
        ...
        try {
            Problem problem = new Problem(dist, new DistribucionSuccessorFunction1(), new DistribucionGoalTest(),
                    heuristico);
    ...
    private void DistSimulatedAnnealingSearch(Distribucion dist) {
        Res.append("\n--Simulated Annealing--\n");
        Res.append("Iteraciones=" + iter.getText() + " Pasos=" + pasos.getText() + " K=" + k.getText() + " Landa="
                + landa.getText() + "\n\n");

        try {
            Problem problem = new Problem(dist, new DistribucionSuccessorFunction1(), new DistribucionGoalTest(),
                    heuristico);
            SimulatedAnnealingSearch search = new SimulatedAnnealingSearch(Integer.parseInt(iter.getText()),
                    Integer.parseInt(pasos.getText()), Integer.parseInt(k.getText()),
                    Double.parseDouble(landa.getText()));
            // search.traceOn();
            tiempoEjecucion = System.currentTimeMillis();
            SearchAgent agent = new SearchAgent(problem, search);
            tiempoEjecucion = System.currentTimeMillis() - tiempoEjecucion;
    ...
    private String printData() {
        ...
        for (int i = 0; i < od.getNumOferta(); i++) {
            res += "Id:" + i + "\tCompany:" + od.getPCompany(i) + "\tCo2:" + od.getPCo2(i) + "\tkWh:"
                    + od.getPKWhTotal(i) + "\tPrecio:" + od.getPPrecio(i) + "\tBeneficio:" + od.getPBeneficio(i) + "\n";
        }
        res += "\nDatos de consumidores\n";
        for (int j = 0; j < od.getNumDemanda(); j++) {
            res += "Id:" + j + "\tNom:" + od.getCNom(j) + "\tCo2Min:" + od.getCCo2Min(j) + "\tkWh:" + od.getCKWh(j)
                    + "\tPrecio:" + od.getCPrecioMax(j) + "\n";
        }
        return res;
    }
    ...
    private void initComponents() {
                ...
                jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel5Layout.createSequentialGroup()
                                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                        .add(jPanel5Layout.createSequentialGroup()
                                                .add(jLabel2)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 44,
                                                        Short.MAX_VALUE)
                                                .add(pasos, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                        .add(jPanel5Layout.createSequentialGroup()
                                                .add(jLabel1)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(iter, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel5Layout
        ...
        jPanel5Layout.setVerticalGroup(
                jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel5Layout.createSequentialGroup()
                                ...
                                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                                        .add(jLabel3)
                                        .add(k, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                                        .add(jLabel4)
                                        .add(landa, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jButton1)
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Heur�stico"));

        buttonGroup2.add(Heco);
        Heco.setText("Preferir ecolog�a");
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Inicializaci�n"));
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Cr�ditos"));

        jTextArea1.setBackground(new java.awt.Color(236, 233, 216));
        jTextArea1.setColumns(20);
        jTextArea1.setEditable(false);
        jTextArea1.setRows(5);
        jTextArea1.setText("Pr�ctica 1� de IA\n2006/2007 Q1\n\nAutores:\nDaniel Garc�a P�rez\nSergio Vico Marfil");
        ...
        jTabbedPane1.addTab("Configuraci�n", jPanel1);
                ...
                jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel9Layout.createSequentialGroup()
                                ...
                                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(jButton2)
                                        .add(jScrollPane2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 390,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                ...
                jPanel10Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel10Layout.createSequentialGroup()
                                ...
                                .add(jPanel10Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(jScrollPane3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 332,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(jButton3))
                        ...
                        .add(jPanel11Layout.createSequentialGroup()
                                ...
                                .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                        ...
                                        .add(jPanel11Layout.createSequentialGroup()
                                                .add(jLabel5)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(npaqs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                                .add(15, 15, 15)
                                                .add(jLabel6)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(ncons, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                ...
                jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel3Layout.createSequentialGroup()
                                ...
                                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 236,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(jPanel3Layout.createSequentialGroup()
                                                .add(Ejecucion)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(progress, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 137,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                        .add(Exportar))
                                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        jPanel3Layout.setVerticalGroup(
                jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel3Layout.createSequentialGroup()
                                .add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 366,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(32, 32, 32)
                                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(Ejecucion)
                                        .add(progress, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                ...
                jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel2Layout.createSequentialGroup()
                                ...
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                        .add(jPanel11, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .add(jPanel10, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .add(jPanel9, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        ...
                        .add(jPanel2Layout.createSequentialGroup()
                                ...
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(jPanel3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .add(jPanel2Layout.createSequentialGroup()
                                                .add(jPanel9, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(jPanel10, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(jPanel11, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap()));

        jTabbedPane1.addTab("Datos y Ejecuci�n", jPanel2);

        jPanel13.setBorder(javax.swing.BorderFactory.createTitledBorder("Configuraci�n"));

        jLabel8.setText("N� Paquetes");

        jLabel9.setText("N� Consumidores");

        jLabel10.setText("N� Pruebas");
        ...
        jLabel11.setText("Configuraci�n del Simulated Annealing");
        ...
        jPanel13Layout.setHorizontalGroup(
                jPanel13Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel13Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel13Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(bpaqs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(bpruebs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(bcons, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .add(56, 56, 56)
                                .add(jSeparator1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 50,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel13Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(jLabel11)
                                                ...
                                                .add(jPanel13Layout
                                                        ...
                                                        .add(jPanel13Layout.createSequentialGroup()
                                                                ...
                                                                .add(bspasos,
                                                                        ...
                                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel13Layout
                                                                .createSequentialGroup()
                                                                .add(jLabel12)
                                                                .addPreferredGap(
                                                                        org.jdesktop.layout.LayoutStyle.RELATED)
                                                                .add(bsiter,
                                                                        ...
                                                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 42,
                                                        Short.MAX_VALUE)
                                                .add(jPanel13Layout
                                                        .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                ...
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel13Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(bsk, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(bslanda, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                                        ...
                                        .add(jPanel13Layout.createSequentialGroup()
                                                ...
                                                .add(jPanel13Layout
                                                        ...
                                                        .add(bpruebs, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                        .add(jSeparator1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 93,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(jPanel13Layout.createSequentialGroup()
                                                .add(jLabel11)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(jPanel13Layout
                                                        .createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                                                        .add(jLabel12)
                                                        .add(bsiter, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                                        .add(jLabel14)
                                                        .add(bsk, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                .add(jPanel13Layout
                                                        ...
                                                        .add(bslanda, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                                        .add(bspasos, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel14Layout.setVerticalGroup(
                jPanel14Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel14Layout.createSequentialGroup()
                                .add(jScrollPane5, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 221,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(14, Short.MAX_VALUE)));

        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder("Ejecuci�n"));
                ...
                jPanel15Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel15Layout.createSequentialGroup()
                                ...
                                .add(jPanel15Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                        .add(bprogress, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .add(bExportar)
                                        .add(Bejecutar))
                ...
                jPanel12Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel12Layout.createSequentialGroup()
                                ...
                                .add(jPanel12Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel15,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel14,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel13,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap()));
        jPanel12Layout.setVerticalGroup(
                jPanel12Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jPanel12Layout.createSequentialGroup()
                                .addContainerGap()
                                .add(jPanel13, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel14, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED,
                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .add(jPanel15, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));

        jTabbedPane1.addTab("Bater�a de pruebas", jPanel12);
    ...
    private void ejecutarBateria() {
        ...
        for (int prueba = 0; prueba < nump; prueba++) {
            ...
            for (i = 0; i < ncons; i++) {
                ...
                switch (co2) {
                    case 1:
                        precio = r.nextInt(4) + 1;
                        break;
                    case 2:
                        precio = r.nextInt(5) + 3;
                        break;
                    case 3:
                        precio = r.nextInt(5) + 6;
                        break;
                    default:
                        precio = r.nextInt(10) + 1;
                        break;
                }
            ...
            for (i = 0; i < 4; i++) {
                ...
                switch (i) {
                    case 0:
                        h = new DistribucionHeuristicFunction1();
                        break;
                    case 1:
                        h = new DistribucionHeuristicFunction2();
                        break;
                    case 2:
                        h = new DistribucionHeuristicFunction3();
                        break;
                    case 3:
                        h = new DistribucionHeuristicFunction4();
                        break;
                }
        ...
        bRes.append("N� Pruebas:" + bpruebs.getText() + " N� Paquetes:" + bpaqs.getText() + " N� Consumidores:"
                + bcons.getText() + "\n\n");
        ...
        for (int k = 0; k < 4; k++) {
            ...
            for (int q = 0; q < 5; q++) {
                bRes.append(init[q]);
                bRes.append(" Media:" + (((int) ((-100) * resultadoH[k + q * 4])) / 100.0) + ", Tiempo: "
                        + tiempoH[k + q * 4] + "ms\n");
            }
        }

        bRes.append("\n--Simulated Annealing--\n");
        bRes.append("Iteraciones=" + bsiter.getText() + " Pasos=" + pasos.getText() + " K=" + bsk.getText() + " Lambda="
                + bslanda.getText() + "\n\n");
        ...
        for (int k = 0; k < 4; k++) {
            ...
            for (int q = 0; q < 5; q++) {
                bRes.append(init[q]);
                bRes.append(" Media:" + (((int) ((-100) * resultadoS[k + q * 4])) / 100.0) + ", Tiempo: "
                        + tiempoS[k + q * 4] + "ms\n");
            }
        }
    ...
    private void DistBateriaHillClimbingSearch(int id, int nump, double r[], long t[], Distribucion dist,
            DistribucionHeuristic h) {
        try {
    ...
    private void DistBateriaSimulatedAnnealingSearch(int id, int nump, double r[], long t[], Distribucion dist,
            DistribucionHeuristic h) {
        try {
            Problem problem = new Problem(dist, new DistribucionSuccessorFunction1(), new DistribucionGoalTest(), h);
            SimulatedAnnealingSearch search = new SimulatedAnnealingSearch(Integer.parseInt(bsiter.getText()),
                    Integer.parseInt(bspasos.getText()), Integer.parseInt(bsk.getText()),
                    Double.parseDouble(bslanda.getText()));
            tiempoEjecucion = System.currentTimeMillis();
            SearchAgent agent = new SearchAgent(problem, search);
            t[id] += (System.currentTimeMillis() - tiempoEjecucion) / nump;
            r[id] += (double) (h.getHeuristicValue((Distribucion) search.getGoalState())) / (double) nump;
    ...
    private void rellenarTablas(int numC, int numP) {
        ...
        for (int j = 0; j < maxP; j++) {
            ...
            switch (co2) {
                case 1:
                    model1.setValueAt(r.nextInt(4) + 1, j, 2);
                    model1.setValueAt(r.nextInt(21) + 30, j, 5);
                    break;
                case 2:
                    model1.setValueAt(r.nextInt(5) + 3, j, 2);
                    model1.setValueAt(r.nextInt(21) + 20, j, 5);
                    break;
                case 3:
                    model1.setValueAt(r.nextInt(5) + 6, j, 2);
                    model1.setValueAt(r.nextInt(21) + 5, j, 5);
                    break;
                default:
                    model1.setValueAt(r.nextInt(10) + 1, j, 2);
        ...
        for (int i = 0; i < maxC; i++) {
            ...
            switch (co2) {
                case 1:
                    model2.setValueAt(r.nextInt(4) + 1, i, 2);
                    break;
                case 2:
                    model2.setValueAt(r.nextInt(5) + 3, i, 2);
                    break;
                case 3:
                    model2.setValueAt(r.nextInt(5) + 6, i, 2);
                    break;
                default:
                    model2.setValueAt(r.nextInt(10) + 1, i, 2);
                    break;
            }
