...
public class ProbAntenasSuccessorFunction implements SuccessorFunction {
   ...
   public List getSuccessors(Object aState) {
      ...
      for (int i = 0; i < board.getNumAntenas(); i++) {
         ...
         ProbAntenasBoard newBoardU = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
         if (newBoardU.MoverAntena(i, -1, 0)) {
            String S = new String(ProbAntenasBoard.MOVER + " " + i + " Up");
            retVal.add(new Successor(S, newBoardU));
         }
         // Movemos hacia Abajo
         ProbAntenasBoard newBoardD = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
         ...
         ProbAntenasBoard newBoardL = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
         ...
         ProbAntenasBoard newBoardR = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
         ...
         ProbAntenasBoard newBoardPU = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
         ...
         ProbAntenasBoard newBoardPD = new ProbAntenasBoard(board.getNumAntenas(), board.getMaxPotencia(),
               board.getAntenas(), board.getDimPlano(), board.getPlano());
