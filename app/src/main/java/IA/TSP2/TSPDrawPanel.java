    ...
    public void paint(Graphics g) {
        ...
        if (init) {
            ...
            for (int i = 0; i < nc - 1; i++) {
                g2.drawLine((city[path[i]][0] * sep) + gapX + 7, (city[path[i]][1] * sep) + gapY + 7,
                        (city[path[i + 1]][0] * sep) + gapX + 7, (city[path[i + 1]][1] * sep) + gapY + 7);

            }
            g2.drawLine((city[path[nc - 1]][0] * sep) + gapX + 7, (city[path[nc - 1]][1] * sep) + gapY + 7,
                    (city[path[0]][0] * sep) + gapX + 7, (city[path[0]][1] * sep) + gapY + 7);
