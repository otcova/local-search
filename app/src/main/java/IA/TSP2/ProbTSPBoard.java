...
public class ProbTSPBoard {
     ...
     *
     * Crea una nueva instancia del problema del viajante de comercion con nc
     * ciudades
     * 
    ...
    /*
     * !\brief Genera una instancia del TSP con un camino inicial y una matriz de
     * distancias
     *
     * Genera una instancia del problema del viajante de comercio recibiendo el
     * numero de ciudades
    ...
    /*
     * !\brief Retorna la distancia entre la ciudad i y la siguiente ciudad en el
     * camino
     *
     */
