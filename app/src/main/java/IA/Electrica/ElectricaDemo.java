...
public class ElectricaDemo {
    ...
    private static void ElectricaHillClimbingSearch(Electrica board) {
        ...
        try {
            ...
            Problem problem = new Problem(board, new ElectricaSuccessorFunction(), new ElectricaGoalTest(),
                    new ElectricaHeuristicFunction());
     ...
     * try {
     * Problem problem = new Problem(TSPB,new ProbTSPSuccessorFunction(), new
     * ProbTSPGoalTest(),new ProbTSPHeuristicFunction());
     * SimulatedAnnealingSearch search = new
     * SimulatedAnnealingSearch(2000,100,5,0.001);
     * //search.traceOn();
     * SearchAgent agent = new SearchAgent(problem,search);
     * 
     * System.out.println();
