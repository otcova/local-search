...
public class jProbes {
	...
	public static void EscriureProblema(String ruta, Electrica eini, Electrica efi, long temps, int passos, int si,
			int heur, int op, int alg) {
		...
		try {
			...
			salida.println(alg + " " + si + " " + heur + " " + op + " " + temps + " " + passos + "  " + eini.obteNcomp()
					+ " " + eini.obteNpaquets() + " " + eini.obteNdemandes() + " " + eini.obteValHeuristic(heur) + " "
					+ eini.obteBenefici() + " " + eini.obteFactorMig() + " " + eini.obtePagament() + " "
					+ eini.obteQnoAssignada() + " " + eini.obteQnoConsumida() + " " + efi.obteValHeuristic(heur) + " "
					+ efi.obteBenefici() + " " + efi.obteFactorMig() + " " + efi.obtePagament() + " "
					+ efi.obteQnoAssignada() + " " + efi.obteQnoConsumida());
