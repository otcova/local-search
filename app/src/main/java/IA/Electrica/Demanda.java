...
public class Demanda {
	...
	public Demanda(Demanda d2, int i) {
		// en realitat consumidors i paquets no canvien pertant nomes nova la assignacio
		// de la demanda aquesta funcio no fer servir!!
	...
	public int consultaNumCompanyia() {
		...
		if (pq != null)
			return pq.consultaNumCompanyia();
		else
			return -1;
	}
